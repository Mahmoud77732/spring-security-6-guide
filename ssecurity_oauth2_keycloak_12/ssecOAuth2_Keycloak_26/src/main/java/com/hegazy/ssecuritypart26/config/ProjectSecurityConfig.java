    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests(
                (requests) -> requests
                        ...
                        .requestMatchers(
                            "/", "/home", "/notices", "/register", "/contact", "/error", "/login/**", "/logout", 
                            "/assets/**"
                            ).permitAll()
        );
        ...
        // JwtAuthenticationConverter: convert JWT to authorities
        ...
        http.oauth2ResourceServer(rsc -> rsc.jwt(
            jwtConfig -> jwtConfig.jwtAuthenticationConverter(jwtAuthConverter)
        ));
